...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, required=True, help='The root dir of images.') #/home/abe/KidneyM/dino/dino-vit-features/demo
    parser.add_argument('--save_dir',default="/home/abe/KidneyM/dino/dino-vit-features/Coseg", type=str, help='The root save dir for results.') #
    parser.add_argument('--load_size', default=448, type=int, help='load size of the input images. If None maintains'
