...
class ViTExtractor:
    ...
    def __init__(self, model_type: str = 'dino_vitb16', stride: int = 4,w_path:str="/home/abe/KidneyM/dino/pas_glomerulus_exp001/checkpoint0600.pth", model: nn.Module = None, device: str = 'cuda'):
        """
        ...
        if model is not None:
            ...
            self.model = ViTExtractor.create_model(model_type,w_path)
    ...
    @staticmethod
    def create_model(model_type: str,w_path: str) -> nn.Module:
        """
