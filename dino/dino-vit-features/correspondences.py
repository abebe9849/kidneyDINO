...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir',default="/home/abe/KidneyM/dino/dino-vit-features/Corr", type=str, help='The root save dir for results.') #
    ...
    with torch.no_grad():
        ...
        for pair_dir in tqdm(pair_dirs):
            curr_images = [x for x in pair_dir.iterdir() if x.suffix.lower() in ['.jpg', '.png', '.jpeg']][1:3]
