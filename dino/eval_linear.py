...
class TrainDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        file_path = "/home/abe/KidneyM/hubmap2021/yolov5/SAHI/runs/predict/exp/croped/"+self.paths[idx]+".jpg"
...
sgkf = StratifiedGroupKFold(n_splits=4,random_state=2022,shuffle=True)
all_df = pd.read_csv("/home/abe/KidneyM/dino/pas_glomerulus/tmp.csv")

print(all_df["target"].value_counts())
dict_ = {"IGA":1,
         "MCN":2,#
         "MEN":3,
         "MGA":4,#判別不可能？
...
def func_1(x):
    try:
        ...
        return 0
all_df["label"]= np.vectorize(func_1)(
    all_df["target"])
...
folds = all_df[all_df["fold"]!=4].reset_index(drop=True)
test_df = all_df[all_df["fold"]==4].reset_index(drop=True)
...
def eval_linear(args):
    ...
    args.num_labels = all_df["label"].nunique()
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if epoch % args.val_freq == 0 or epoch == args.epochs - 1:
            ...
            if args.num_labels>2:
                ...
                report = classification_report(valid_labels, np.argmax(preds,axis=1))
            else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='/home/abe/KidneyM/dino/pas_glomerulus_exp001/checkpoint.pth', type=str, help="Path to pretrained weights to evaluate.")
    ...
    parser.add_argument('--output_dir', default="/home/abe/KidneyM/dino/pas_glomerulus_exp001/7cls", help='Path to save logs and checkpoints')
    ...
    args.output_dir = args.output_dir+"/"+str(args.fold)
